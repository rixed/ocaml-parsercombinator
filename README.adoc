...
[source,ml]
----
let quoted_char ?(what="character") =
  (char ~what:"escape sequence" '\\' -+
   (* TODO: numercial escape sequences *)
   anything ~what:"escaped character" >>: function
     | 'n' -> '\n'
     | 'r' -> '\r'
     | 'b' -> '\b'
     | 't' -> '\t'
...
let quoted_string =
  ...
  repeat_greedy ~sep:none ~what:"a quoted string" quoted_char +-
...
struct
  ...
  let stream_of_string str = Conf.stream_of_string str, 0, 0
end
----
